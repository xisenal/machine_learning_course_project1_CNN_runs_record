...
def train_kfold(data_root='data/CUB_200_2011', epochs=10, batch_size=16, lr=1e-3, num_folds=10):
    ...
    config = {
        ...
        'augmentations': {
            ...
            'RandomResizedCrop': {'size': 128, 'scale': [0.7, 1.0], 'ratio': [0.9, 1.1]},
        },
        'weight_decay': 5e-4,
    ...
    for fold in range(num_folds):
        ...
        best_val_acc = 0.0
        patience, bad_epochs = 9, 0  # 提高早停容忍度，尽量跑满 10 个 epoch 观察曲线
        fold_metrics = []
